    ...
    setDocument = Sizzle.setDocument = function (node) {
      ...
      sortOrder = docElem.compareDocumentPosition
        ? function (a, b) {
            ...
            if (
              (compare = b.compareDocumentPosition && a.compareDocumentPosition && a.compareDocumentPosition(b))
            ) {
      ...
      pseudos: {
        ...
        lang: markFunction(function (lang) {
          ...
          return function (elem) {
            ...
            do {
              if (
                (elemLang = documentIsXML ? elem.getAttribute('xml:lang') || elem.getAttribute('lang') : elem.lang)
              ) {
