    ...
    for (i = 0, _length_i = geometry.faces.length; i < _length_i; i++) {
      ...
      if (face instanceof THREE.Face3) {
        ...
        vertex = new ThreeBSP.Vertex(
          ...
          new THREE.Vector2(faceVertexUvs[0].u, faceVertexUvs[0].v)
        )
        ...
        vertex = new ThreeBSP.Vertex(
          ...
          new THREE.Vector2(faceVertexUvs[1].u, faceVertexUvs[1].v)
        )
        polygon.vertices.push(vertex)
        ...
        vertex = new ThreeBSP.Vertex(
          ...
          new THREE.Vector2(faceVertexUvs[2].u, faceVertexUvs[2].v)
        )
        polygon.vertices.push(vertex)
        ...
        vertex = new ThreeBSP.Vertex(
          ...
          new THREE.Vector2(faceVertexUvs[3].u, faceVertexUvs[3].v)
        )
        polygon.vertices.push(vertex)
      } else {
  ...
  ThreeBSP.prototype.toGeometry = function () {
    ...
    for (i = 0; i < polygon_count; i++) {
      ...
      for (j = 2; j < polygon_vertice_count; j++) {
        ...
        face.vertexNormals.push(verticeNormals[0], verticeNormals[1], verticeNormals[2])
